...
function Odev({ odevad, ogretmenad, odevtarihi, odevsuresi }) {
        ...
        <div className='odev'>
            <div className="odevaciklama">
                <div className="odevbaslik flex-row">
                    <Checkbox disabled={checkboxDisabled ? true : false} color='success' onChange={checkboxChange} />
            ...
            <div className='odevbuton'>
                <Button variant="contained" color='black' onClick={buttonClicked} disabled={buttonDisabled} sx={{ borderRadius: '20px' }}>Gönder</Button>
            </div>
            <Snackbar open={open} anchorOrigin={{ vertical: "bottom", horizontal: "center" }}>
                <Alert variant="filled" severity="success" action={<Button color="white" size="small" onClick={undoAction}>Geri Al</Button>}>
                    Ödev başarıyla gönderildi
                </Alert>
            </Snackbar>
            <Snackbar open={open2} anchorOrigin={{ vertical: "bottom", horizontal: "center" }}>
